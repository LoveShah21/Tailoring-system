    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['name'], name='idx_permission_name')],
            },
        ),
        migrations.CreateModel(
            name='Role',
            ...
            options={
                'db_table': 'users_role',
                'indexes': [models.Index(fields=['name'], name='idx_role_name'), models.Index(fields=['is_deleted'], name='idx_role_is_deleted')],
            },
        ),
        migrations.CreateModel(
            name='RolePermission',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='user_roles', to='users.role')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='user_roles', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['role'], name='idx_role_perm_role'),
        ),
